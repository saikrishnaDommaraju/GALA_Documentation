  ...
  return (
    <main style={{ display: "flex" }}>
      ...
      >
        ...
        <ScrollDiv scrollheight="175px">
          ...
          {projData &&
            ...
            sb2Data
              ...
              .map((cl) => (
                <div class="ax_spantitle">
                  <span className={`${styleSB["nav-link"]} ${styleSB["nav-link-drw"]}
                  ...
                  {/* If CheckList Saved Into ChecklistResponse then IsSaved True */}
                  { cl.isSaved?  <span className={`${activeChain[1] === cl.id ? styleSB.active : ""}`}
                    key={"cl-" + cl.id}
                    id={"lc-" + cl.id} >   
                      <Checkmark size='25px' />  
                  </span> : '' 
        ...
        <br></br>
        <button class="icon-waitproj ax_padding5"   onClick={() => loadCheckFileList('check', activeChain[0])}></button>
          {projData &&
            sb2Holds === "docs" &&
            sb2Data.length > 0 &&
            sb2Data
